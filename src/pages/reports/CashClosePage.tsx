...
// El cierre de caja es STANDARD desde ago-2026 (decisión de producto: el
// corte diario es operación básica del gym, no admin avanzado). El desglose
// de gastos (BC expenses) sigue en Plus — un gym Standard ve esa sección
// vacía.
